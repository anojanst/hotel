...
<section class="content">
    <div class="nav-tabs-custom">
        <div class="tab-content">
            <div class="row">
                <div class="col-lg-12">
                    <h4><strong>Occupied Room Report</strong></h4>
                    
                </div>
            </div>
            <div class="row">               
                <form action="reports.php?job=occupied_room" method="post" class="search">
                    <div class="col-lg-2">
			...
			<div class="row">
				<div class="col-xs-12">
					{if $search=="on"}
					{php}list_occupied_dates($_SESSION[from_date],$_SESSION[to_date]);{/php}
					{/if}
				</div>
			</div>
		</div>
