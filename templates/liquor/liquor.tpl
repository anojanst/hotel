 	...
 	<section class="content">
  		<div class="nav-tabs-custom">
  			<div class="tab-content">
   				<div class="row">
                    <div class="col-lg-12">
                     <h2><strong>Liqour </strong></h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-6" style="margin-top: 10px;">	
                            <div class="panel-body">
                                <form name="liquor_type_form" role="form" action="liquor.php?job=save" method="post">
                                    <div class="row" style="margin-bottom: 10px; margin-left: 20px;">
                                        <div class="col-lg-12">
                                            Liquor Type
                                            <input class="form-control" name="liquor" value="{$liquor}" required placeholder="Liquor Type">
                                        </div>                                
                                    </div>
                                    <div class="row" style="margin-bottom: 10px; margin-left: 20px;">
                                        <div class="col-lg-6">
