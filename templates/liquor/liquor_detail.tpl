					...
					<form name="liquor_detail_form" role="form" action="liquor_detail.php?job=save" method="post">
                            ...
                            <div class="row" style="margin-bottom: 10px;">
                             ...
                             <div class="row" style="margin-bottom: 10px;">
								<div class="col-lg-12">
									25ml Price
									<input class="form-control" name="price_25" value="{$price_25}" required placeholder="25ml Price">
								</div>                                
							</div>
                              ...
                              <div class="row" style="margin-bottom: 10px;">
								<div class="col-lg-12">
									50ml Price
									<input class="form-control" name="price_50" value="{$price_50}" required placeholder="50ml Price">
								</div>                                
							</div>
