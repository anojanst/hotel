...
if ($_SESSION['login'] == 1) {
	if (check_access($module_no, $_SESSION['user_id']) == 1) {
		...
		elseif($_REQUEST['job']=='update_item'){
			...
			//update_bar_sales_item_ledger($vehicle_id ,$bar_sales_no);
		...
		elseif($_REQUEST['job']=='bar_sales'){
			...
			if($_REQUEST['ok']=='Save'){
				...
				save_bar_sales($bar_sales_no, $date, $customer_name,$discount_type, $discount, $prepared_by, $remarks, $total, $order_type, $ref_no, $booking_ref);
